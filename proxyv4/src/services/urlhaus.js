/**
 * URLhaus API service for AmanQR Security Proxy
 * Checks URLs against Abuse.ch URLhaus malware database
 * @module services/urlhaus
 */
...
/**
 * Checks a URL against URLhaus malware database
 * @param {string} url - The URL to check
 * @returns {Promise<import('../types/index.js').URLhausResult>} URLhaus check result
 */
